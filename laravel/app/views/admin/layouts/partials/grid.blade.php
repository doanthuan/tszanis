                ...
                foreach ($items as $i => $item) {?>
                    <tr>
                        ...
                        <?php foreach($columns as $column ){
                            ...
                            else if(isset($column['published']) && $column['published'] == true)
                            {
                                echo '<td>'.\Goxob\Core\Helper\Html::gridPublish($item->$column['name'], $i, $column['name']).'</td>';
                            }
                        ...
                        @if($grid->actionCol)
                        <td><?php echo $grid->getActionLinks($item, $i)?></td>
                        @endif
                    </tr>
                <?php }
            }
