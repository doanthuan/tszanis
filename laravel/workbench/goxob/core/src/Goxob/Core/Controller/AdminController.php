...
//        }
    ...
    public function publish()
    {
        ...
        return Redirect::away($this->objectUrl);
    }
    ...
    public function saveSortOrder()
    {
        ...
        if ($return === false)
        {
            return Redirect::away($this->objectUrl)->with('success', trans('Reorder Failed'));
        }
        else
        {
            return Redirect::away($this->objectUrl)->with('success', trans('Reorder Success'));
        }
    }
